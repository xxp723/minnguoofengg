...
export function getFeaturePrompts({ settings = {}, imageApi = null } = {}) {
  ...
  /* ======================================================================
     ...
     ====================================================================== */
  const patRuleText = '8. 拍一拍：**`[拍一拍] 角色名：身体部位`**，像 QQ/微信戳一戳；只在想轻轻提醒用户回复、安慰、撒娇、逗用户或贴合当前情绪时偶尔使用；内容只能写一个身体部位，如“肩膀/脑袋/手背/后背”，禁止写整句话、动作描写、非身体部位或任何解释；不能掉格式，前端只显示系统小字“角色名拍了拍你的身体部位”。';
